    ...
    >
      ...
      >
        ...
        <div className="w-full lg:w-[70%] flex flex-col">
          {/* Header */}
          <div
            className="mx-auto mb-6 flex items-center justify-between"
            style={{
              marginBottom: "3px",
            }}
          >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col sm:flex-row justify-between gap-4">
                        ...
                        >
                          ...
                          <button
                            ...
                            style={{
                              background:
                                "linear-gradient(135deg, rgba(217,92,43,0.12), rgba(217,92,43,0.06))",
                              border: "1px solid rgba(217,92,43,0.2)",
                            }}
                          >
                            <div
                              className="absolute inset-0 opacity-0 group-hover/share:opacity-100 transition-opacity duration-300"
                              style={{
                                background:
                            ...
                            {copiedId === item.id ? (
                              ...
                              <Copy
                                className="w-5 h-5 relative z-10 transition-transform duration-300 group-hover/share:scale-110"
                                style={{ color: "var(--accent-primary)" }}
                              />
                            )}
                          </button>
                          ...
                          <button
                            ...
                            style={{
                              background:
                                "linear-gradient(135deg, rgba(30,107,107,0.12), rgba(30,107,107,0.06))",
                          ...
                          >
                            ...
                            ></div>
                            <Share2
                              className="w-5 h-5 relative z-10 transition-transform duration-300 group-hover/share:rotate-12"
                          ...
                          {openShareId === item.id && (
                            ...
                            >
                              ...
                              <div className="flex flex-col gap-1 p-2">
                                ...
                                <button
                                  onClick={(e) =>
                                    shareToSocial(e, "instagram", item)
                                  }
          ...
          >
            ...
            <div className="space-y-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, var(--black-soft), var(--black-deep))",
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="1.5"
                    d="M12 8v13m0-13V6.5a1.5 1.5 0 112 0V7m-2 1h2m0 0v2m0-2h-2"
                  />
                </svg>
